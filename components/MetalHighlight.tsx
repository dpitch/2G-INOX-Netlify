...
export const MetalHighlight: React.FC = () => {
  ...
  const combinedRef = useCallback((node: HTMLElement | null) => {
    ...
    // Assign to the ref from useScrollReveal
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2">
        {/* Image Side */}
        <div className="relative min-h-[400px] md:min-h-[500px] lg:min-h-[600px] lg:h-auto overflow-hidden order-2 lg:order-1">
          ...
          {/* Floating Badge */}
          <div className={`absolute bottom-6 left-4 md:bottom-8 md:left-6 lg:bottom-10 lg:left-12 bg-brand-dark/90 backdrop-blur-sm border border-white/10 p-4 md:p-6 max-w-[220px] md:max-w-[280px] z-30 transition-all duration-1000 delay-700 ease-luxury ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            <div className="flex items-baseline gap-2 mb-1 md:mb-2">
              <span className="text-2xl md:text-4xl lg:text-6xl font-light text-white">100%</span>
        ...
        {/* Content Side */}
        <div className="relative py-16 md:py-24 flex flex-col justify-center order-1 lg:order-2 lg:border-l border-white/5">
